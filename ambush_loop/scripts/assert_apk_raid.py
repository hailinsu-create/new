...
REQUIRED_ASSETS = (
    ...
    "assets/scripts/c2/context_prompt.gdc",
    "assets/scripts/c2/skill_wheel.gdc",
)
...
def main() -> int:
    ...
    p.add_argument("apk")
    p.add_argument("--version", default="0.5.27")
    p.add_argument("--version-code", type=int, default=33)
    args = p.parse_args()
