...
【手机】点肖像选人。点地走；短拖拖图；长按空地奔跑。靠近匣/岗出热区。岗哨背面出「绕背」或「割喉」。未选中肖像点「跟」跟上。底栏匍匐 / 背包 / 需枪。
返回键打开菜单，不直接退出。警报中只留暂停 / 倍速 / 中止。清空记忆在设置里点两次。

键 / 操作              作用
1 / 2 / 3 或左侧卡片 / 底栏肖像    选步枪手 / 机枪手 / 侦察兵
左键点地                走路（双击奔跑）
左键点掩体              部署选中队员（青弧=保护方向）
悬停掩体                预览该位保护弧
C                       匍匐（阴影里躲岗哨黄锥）
Q                       角色技能：灰狼割喉 / 铁砧埋雷 / 夜枭望远镜
W                       口哨或诱饵
Z                       包扎 / 捆绑击倒的岗哨
滚轮 / 方向键           缩放 / 平移镜头
F1 / F2                 镜头跟随 / 镜头回中
