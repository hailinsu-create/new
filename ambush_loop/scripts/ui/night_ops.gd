...
const OLIVE_HI := Color(0.76, 0.68, 0.40)
...
static func theme() -> Theme:
	...
	t.set_stylebox("panel", "PanelContainer", dossier(PANEL, Color(0.42, 0.34, 0.18), 16, 6))
	t.set_stylebox("panel", "Panel", dossier(PANEL, Color(0.40, 0.32, 0.16), 12, 4))
