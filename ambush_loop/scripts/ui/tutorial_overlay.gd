...
const YARD_STEPS := [
	...
	{
		"title": "3 / 3  ·  锁死观看",
		"body": "空格或底栏「警报」拉响后计划冻结，不能再微操，只能暂停/变速观看。逃逸或全灭都会穿梭失败，但会记录「情报已记录」和漏网路线。下一世恢复上轮计划，可以改朝向。陷阱路线：橙线侧翼从东廊绕出，只锁红线主路会漏。",
	},
]
...
const DEPOT_STEPS := [
	...
	{
		"title": "油库 2 / 2  ·  绊索换人",
		"body": "西暗道影探晚 2.2 秒才从西墙夹缝南下（SETUP 暗芯片倒计时）。灰狼锁主路，铁砧朝北等东廊，夜枭看南闸；把唯一绊索铺在西暗道。先到的两路会把南闸弹药打空。弹包一人。警报后不能微操。陷阱路线：绿线西暗道晚到，忽略它南闸会被先到两路打空。",
	},
]
