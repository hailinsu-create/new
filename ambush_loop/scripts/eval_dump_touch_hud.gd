...
## Forced-touch HUD stills for v0.5.31 phone feel: west trio dest kept
## (span 3, no west-wall hug), bodies/rings at visual floor (~0.16) +
## camera at ~0.26 clamp, south-corridor full path y=14 pulled
