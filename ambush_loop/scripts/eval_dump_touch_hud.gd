...
## Forced-touch HUD stills for v0.5.34 phone feel: west trio dest spread
## (span 5, (6,7)/(5,15), on-ring extra cut, no west-wall hug), bodies/rings
## at visual floor (~0.16) + camera at ~0.30, south-corridor full path y=14
