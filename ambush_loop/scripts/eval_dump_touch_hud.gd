...
## Forced-touch HUD stills for v0.5.35 phone feel: west trio dest spread
## (span 5, (6,7)/(5,16), west-follow detour ≤6, no west-wall hug), bodies/rings
## at visual floor (~0.16) + camera at ~0.32, south-corridor full path y=14
