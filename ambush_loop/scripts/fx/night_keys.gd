...
func _draw() -> void:
	...
	match atmosphere_id:
		...
		"pump":
			...
			_pool(Vector2(26.4 * t, 13.4 * t), 22.0, Color(0.38, 0.88, 0.62, 0.06 if saving else 0.10))
		"railcut":
		...
		_:
			...
			_pool(Vector2(10.6 * t, 16.6 * t), 26.0, Color(0.55, 0.70, 0.42, 0.05 if saving else 0.09))
