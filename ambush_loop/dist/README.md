...
- `AmbushLoop-v0.5.29-touch-slide.apk` — Godot 4.7.2 debug, arm64, phone feel: west trio dest (6,9)/(5,14) span 3 kept, bodies/rings one step smaller + camera one more courtyard/along-file step, south-corridor full path y≤13 (mid x≈21 included), compact 5-key. Same RAID as 0.5.28.
