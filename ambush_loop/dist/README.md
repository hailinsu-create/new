...
- `AmbushLoop-v0.5.3-touch-smooth.apk` — Godot 4.7.2 debug, arm64, phone feel: north world ink, cone-avoid 绕背/跟上, tighter hotspots, yard-loop taps. Same RAID as 0.5.2.
