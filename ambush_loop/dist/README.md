...
- `AmbushLoop-v0.5.23-touch-slide.apk` — Godot 4.7.2 debug, arm64, phone feel: west trio body/ring one step smaller, south-corridor far-side bow capped below ~28px, compact 5-key. Same RAID as 0.5.22.
