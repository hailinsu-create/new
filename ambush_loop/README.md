...
侧载试玩 **v0.5.0 Commandos 2 kit**：`ambush_loop/dist/AmbushLoop-v0.5.0-commandos2-kit.apk`（包名 `com.ambushloop.game`，`versionName` 0.5.0）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.5.0-commandos2-kit/AmbushLoop-v0.5.0-commandos2-kit.apk  
