...
侧载试玩 **v0.5.1 触控简配轨**：`ambush_loop/dist/AmbushLoop-v0.5.1-touch-rail.apk`（包名 `com.ambushloop.game`，`versionName` 0.5.1）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.5.1-touch-rail/AmbushLoop-v0.5.1-touch-rail.apk  
