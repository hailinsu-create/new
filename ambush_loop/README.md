...
侧载试玩 **v0.6.11**：`ambush_loop/dist/AmbushLoop-v0.6.11-yard-props.apk`（包名 `com.ambushloop.game`，`versionName` 0.6.11）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.6.11-yard-props/AmbushLoop-v0.6.11-yard-props.apk  
