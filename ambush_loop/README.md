...
侧载试玩 **v0.5.10 触控手感**：`ambush_loop/dist/AmbushLoop-v0.5.10-touch-rear.apk`（包名 `com.ambushloop.game`，`versionName` 0.5.10）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.5.10-touch-rear/AmbushLoop-v0.5.10-touch-rear.apk  
