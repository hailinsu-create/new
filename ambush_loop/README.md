...
侧载试玩 **v0.5.4 触控手感**：`ambush_loop/dist/AmbushLoop-v0.5.4-touch-clear.apk`（包名 `com.ambushloop.game`，`versionName` 0.5.4）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.5.4-touch-clear/AmbushLoop-v0.5.4-touch-clear.apk  
