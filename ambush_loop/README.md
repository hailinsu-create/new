...
侧载试玩 **v0.5.32 触控手感**：`ambush_loop/dist/AmbushLoop-v0.5.32-touch-slide.apk`（包名 `com.ambushloop.game`，`versionName` 0.5.32）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.5.32-touch-slide/AmbushLoop-v0.5.32-touch-slide.apk  
