...
侧载试玩 **v0.5.3 触控手感**：`ambush_loop/dist/AmbushLoop-v0.5.3-touch-smooth.apk`（包名 `com.ambushloop.game`，`versionName` 0.5.3）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.5.3-touch-smooth/AmbushLoop-v0.5.3-touch-smooth.apk  
