...
侧载试玩 **v0.6.3**：`ambush_loop/dist/AmbushLoop-v0.6.3-alert-chrome.apk`（包名 `com.ambushloop.game`，`versionName` 0.6.3）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.6.3-alert-chrome/AmbushLoop-v0.6.3-alert-chrome.apk  
