...
侧载试玩 **v0.6.0 大改里程碑**：`ambush_loop/dist/AmbushLoop-v0.6.0-overhaul.apk`（包名 `com.ambushloop.game`，`versionName` 0.6.0）。  
直链：https://github.com/hailinsu-create/new/releases/download/v0.6.0-overhaul/AmbushLoop-v0.6.0-overhaul.apk  
