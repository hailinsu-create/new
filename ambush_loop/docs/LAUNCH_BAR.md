...
| Not 8+ | No FOW, no human balance record, three authored yards only, still no sprite pipeline or VO. Those are the usual store-page gaps, not a missing menu. |
...
| C9 | First visit per level: yard 3-step; warehouse F/G/barrel; pump B/flank. Page 1 cannot be skipped via dimmer; auto-mark seen on dismiss | Done |
