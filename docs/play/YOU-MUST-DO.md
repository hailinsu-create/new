...
逐步点击说明见 **[signup.md](./signup.md)**。摘要：

1. 打开 https://play.google.com/console/signup
2. 类型选 **个人**
3. 支付 **$25 一次性**（Visa / Mastercard 等，不要预付卡）
4. 证件、支付资料、银行卡姓名和地址必须是同一套
5. 完成身份验证（可能要几天）
...
- 悬浮窗那两张是用原创国风角色「墨汐」拼的草稿（约 96dp 头像框、关闭角标在圆外），**是合成图，不是真机照片，提交前请用真机演示模式换掉**
