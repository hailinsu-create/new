...
Overlay, screen capture, and notifications are required for full companion. Usage access is optional. Demo mode does not capture the real screen.
...
Full companion is a one-time Google Play unlock (about $0.99). Demo mode stays free.
